...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-0 sm:min-h-[calc(70vh-2rem)] flex-col pt-28 sm:pt-32 pb-2 sm:pb-4 px-2 sm:px-0 overflow-hidden flex items-center justify-start" aria-label="Hero">
      {/* Animated background */}
