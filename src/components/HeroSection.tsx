...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[calc(100vh-2rem)] flex-col pt-28 sm:pt-32 pb-10 sm:pb-12 px-2 sm:px-0 overflow-hidden flex items-center justify-start" aria-label="Hero">
      {/* Animated background */}
